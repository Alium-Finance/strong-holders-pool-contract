...
describe("AliumGaming1155", function() {
    ...
    describe('mutable functions', () => {
        describe('in AliumGaming1155', () => {
            it('#mint', async () => {
                await nft.connect(MINTER_SIGNER).mint(
                    ALICE,
                    1,
                    1,
                    "0x"
            ...
            it('#mintBatch', async () => {
                await nft.connect(MINTER_SIGNER).mintBatch(
                    ALICE,
                    [1, 2],
                    [1, 1],
                    "0x"
            ...
            it('#burn', async () => {
                ...
                await nft.connect(ALICE_SIGNER).burn(
                    1,
                    1
                )
            })
            ...
            it('#burnBatch', async () => {
                ...
                await nft.connect(ALICE_SIGNER).burnBatch(
                    [1, 2],
                    [1, 1]
                )
            })
